  ...
  return (
    <div className="smtcmp-settings-section">
      ...
      <div className="smtcmp-settings-desc">
        聊天模型和执行模型的选择已移动到下方的模型 JSON 配置区。
      </div>
      ...
      <ObsidianSetting name="启用工具" desc="允许 AI 调用 MCP 工具。">
        <ObsidianToggle
      ...
      <ObsidianSetting
        name="最大自动执行轮数"
        desc="控制 AI 在一次对话中最多连续自动执行多少轮“思考 -> 调工具 -> 读取结果 -> 再继续”。数值越高，越像自动代理，但 token 消耗和误调用风险也会增加。"
      >
        <ObsidianTextInput
