...
import { getActiveContextBlockData } from '../context/activeContext'
export { getHeadingBlockRange } from '../context/headingReader'
...
export async function getMentionableBlockData(
  ...
  return getActiveContextBlockData(editor, view)
}
